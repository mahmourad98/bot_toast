...
Offset positionToastBox(
  ...
  switch (direction) {
    case 'topLeft':
      ...
      break;
    case 'topCenter':
      final bool rightOverflow = toastSize.width / 2 > containerRect.right - targetRect.topCenter.dx;
      final bool leftOverflow = toastSize.width / 2 > targetRect.topCenter.dx - containerRect.left;
    ...
    case 'leftTop':
      ...
      break;
    case 'leftCenter':
      final bool topOverflow = toastSize.height / 2 > targetRect.centerLeft.dy - containerRect.top;
      final bool bottomOverflow = toastSize.height / 2 > containerRect.bottom - targetRect.centerLeft.dy;
